...
subprocess.call('ffmpeg -rtsp_transport tcp -i rtsp://admin: password@192.168.1.8:34567/user=admin_password=password_channel=1_stream=0.sdp -q:v 1 -y -v quiet /home/pi/grab.jpg', shell=True)
